...
Small, unofficial Node client for ESPN's men's college basketball data. ESPN serves men's college basketball
under `basketball/mens-college-basketball`, and this wraps those endpoints.

Part of the [espn-api](https://github.com/LeSingh1/espn-api) family. The parent
repo is one client for every sport. This one is just men's college basketball, in the style of
...
cd ncaam-api
node examples/scoreboard.js   # men's college basketball games on the board
